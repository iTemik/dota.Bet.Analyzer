...
class TestTeamsSearch:
    ...
    def test_search_teams_case_insensitive(self, client, app):
        ...
        with app.app_context():
            ...
            cursor.execute(
                "INSERT INTO teams (team_id, rating, name, tag, logo_url) VALUES (?, ?, ?, ?, ?)",
                (100, 1500.0, "Team Liquid", "Liquid", "https://example.com/liquid.png"),
            )
            db.commit()
    ...
    def test_search_teams_by_tag(self, client, app):
        ...
        with app.app_context():
            ...
            cursor.execute(
                "INSERT INTO teams (team_id, rating, name, tag, logo_url) VALUES (?, ?, ?, ?, ?)",
                (200, 1400.0, "Evil Geniuses", "EG", "https://example.com/eg.png"),
            )
            db.commit()
    ...
    def test_search_teams_no_results(self, client, app):
        ...
        with app.app_context():
            ...
            cursor.execute(
                "INSERT INTO teams (team_id, rating, name, tag, logo_url) VALUES (?, ?, ?, ?, ?)",
                (500, 1500.0, "Team Liquid", "Liquid", "https://example.com/liquid.png"),
            )
            db.commit()
